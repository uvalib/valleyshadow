...
<xsl:template name="Single">
	...
	<xsl:if test="//div1[@type='epigraph']/p">
		<p class="p11"><xsl:apply-templates select="//div1[@type='epigraph']/p"/></p>	</xsl:if>
	
	<xsl:if test="//div1/head">
		<p class="p11"><b><xsl:apply-templates select="//div1/head"/></b><br/></p>
	</xsl:if>
	<xsl:if test="//opener/pb[@entity]"><a><xsl:attribute name="href">images/<xsl:value-of select="//opener/pb/@entity"/>.jpg</xsl:attribute><center><img><xsl:attribute name="src">images/<xsl:value-of select='//opener/pb/@entity'/>.gif</xsl:attribute></img></center></a></xsl:if>
	...
	<xsl:if test="//div1[@type='addenda']/p">
		<p class="p11"><xsl:apply-templates select="//div1[@type='addenda']/p"/></p>
	</xsl:if>
...
<xsl:template name="Diary">
	...
	<xsl:choose>
		...
		<xsl:when test="$year"><xsl:for-each select="//div1[@n=$year]">
			<p class="p11"><b><xsl:value-of select="head"/></b></p>
			<xsl:for-each select="div2"><p class="p11"><b><xsl:value-of select="head"/></b></p>
				<xsl:for-each select="div3"><p class="p11"><b><xsl:value-of select="head"/></b></p><p class="p10"><xsl:apply-templates select="p"/></p><p class="p12"><i><xsl:apply-templates select="q"/></i></p></xsl:for-each></xsl:for-each></xsl:for-each>
			<p class="p11"><a><xsl:attribute name="href"><xsl:value-of select="//TEI.2/@id"/></xsl:attribute>View Entire Work</a></p>
		</xsl:when>
		<xsl:when test="$section"><xsl:for-each select="//div1/div2[@n=$section]"><p class="p11"><b><xsl:value-of select="head"/></b></p>
		...
		<xsl:when test="$entry"><xsl:for-each select="//div1/div2/div3[@n=$entry]"><p class="p11"><b><xsl:value-of select="head"/></b></p><p class="p10"><xsl:apply-templates select="p"/></p><p class="p12"><i><xsl:apply-templates select="q"/></i></p></xsl:for-each>
			<p class="p11"><a><xsl:attribute name="href"><xsl:value-of select="//TEI.2/@id"/></xsl:attribute>View Entire Work</a></p>
		</xsl:when>
	...
	<xsl:if test="//div1[@type='introduction']">
		<p class="p10"><b>Introduction:<br/></b><xsl:value-of select="//div1[@type='introduction']/p"/></p>
	</xsl:if>
	<xsl:if test="//div1[@type='introduction']/div2">
		<p class="p10"><xsl:value-of select="//div1[@type='introduction']/div2/p"/></p>
	</xsl:if>
	<xsl:if test="//div1[@type='summary']">
		<p class="p10"><b>Summary:<br/></b><xsl:apply-templates select="//div1[@type='summary']/p"/></p><hr width="75%" />
	</xsl:if>
	...
	<xsl:if test="//div1[@type='entry']">
		<p class="p11"><b><xsl:value-of select="head"/></b></p>
		<xsl:for-each select="//div1[@type='entry']/p"><p class="p10"><xsl:value-of select="."/></p></xsl:for-each>
	</xsl:if>
	...
	<xsl:template name="EDiary">
		...
		<xsl:when test="$year"><xsl:for-each select="//div1[@n=$year]">
			<p class="p11"><b><xsl:value-of select="head"/></b></p>
			<xsl:for-each select="div2"><p class="p11"><b><xsl:value-of select="head"/></b></p>
				<xsl:for-each select="div3"><p class="p11"><b><xsl:value-of select="head"/></b></p><p class="p10"><xsl:apply-templates select="p"/></p><p class="p12"><i><xsl:apply-templates select="q"/></i></p></xsl:for-each></xsl:for-each></xsl:for-each></xsl:when>
		<xsl:when test="$entry"><xsl:for-each select="//div1/div2[@n=$entry]"><p class="p11"><b><xsl:value-of select="head"/></b></p>
			<p class="p10"><xsl:apply-templates select="p"/></p><p class="p12"><i><xsl:apply-templates select="q"/></i></p></xsl:for-each></xsl:when>
		<xsl:otherwise>
		<xsl:if test="//div1[@type='bio']">
			<p class="p10"><b>About <xsl:apply-templates select="//sourceDesc/biblFull/titleStmt/author"></xsl:apply-templates>:<br/></b><xsl:apply-templates select="//div1[@type='bio']/p"/></p>
		</xsl:if>
...
<xsl:template match="lb">
	...
	<xsl:template match="figure">
		<xsl:choose><xsl:when test="@entity"><a><xsl:attribute name="href">images/<xsl:apply-templates select='@entity'/>.jpg</xsl:attribute><br></br><br></br><center><img><xsl:attribute name="src">images/<xsl:value-of select='@entity'/>.gif</xsl:attribute></img></center></a><br/><p class="p11"><b><xsl:value-of select="head"/></b></p>
			</xsl:when>
			<xsl:otherwise><xsl:apply-templates></xsl:apply-templates><br/><br/>
		</xsl:otherwise></xsl:choose>
	</xsl:template>
	...
	<xsl:template match="p/pb">
		<xsl:choose><xsl:when test="@entity"><br/><br/>[<i>page <xsl:apply-templates select="@n"/></i>]<a><xsl:attribute name="href">images/<xsl:apply-templates select='@entity'/>.jpg</xsl:attribute><center><img><xsl:attribute name="src">images/<xsl:value-of select='@entity'/>.gif</xsl:attribute></img></center></a><br/><br/>
		</xsl:when>
	...
	<xsl:template match="pb">
		<xsl:choose><xsl:when test="@entity"><p class="p10"><br/><br/>[<i>page <xsl:apply-templates select="@n"/></i>]<a><xsl:attribute name="href">images/<xsl:apply-templates select='@entity'/>.jpg</xsl:attribute><center><img><xsl:attribute name="src">images/<xsl:value-of select='@entity'/>.gif</xsl:attribute></img></center></a><br/><br/></p>
		</xsl:when>
			
			<xsl:otherwise><p class="p10"><br/><br/>[<i>page <xsl:apply-templates select="@n"/></i>]<br/></p></xsl:otherwise></xsl:choose>
	</xsl:template>
