...
<body bgcolor="#FFFFFF" link="#cd7f32" vlink="#00009c">
	<div style="width:100%;text-align:center;" id="no-javascript"><h3 class="warning">This page requires Javascript. Please ensure that you have enabled Javascript in your browser's preferences</h3></div>
	<div id="form">
...
<blockquote>
<b>Note:</b> The wild card character is <b>*</b>. It can be substituted for any number of characters at the middle or back of a word. Please see <a href="VoS/reference/tips.html"><b>Tips for Searching</b></a> for a full explanation. </blockquote>
<hr>
<p> Search for word or phrase: <br><input name="search_text" size="40"></p>
<p> within </p>
<p><select id="docs" name="docs"><optgroup label="region">
...
<br>Group results by <select id="sort" name="sort"><option value="">closest match</option>
<option value="title_string asc">document title</option></select><div style="padding: 2em;">
