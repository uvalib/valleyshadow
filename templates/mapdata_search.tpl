...
<html>
   ...
   <body BGCOLOR="#FFFFFF" >
      ...
      <div id="form">
         ...
         <hr>
         <center>
            <form method="get" action="/mapdata_search_results.html" name="mapdataSearchForm"><input name="q" id="query" type="hidden"><input value="50" name="rows" type="hidden"><input value="0" name="start" type="hidden"><table>
                  <tr>
                     <td><b>Battle</b></td>
                     <td><b>Regiment</b></td>
                     <td><b>Brigade</b></td>
                  ...
                  <tr>
                     <td rowspan="3"><select size="5" name="battle">
                           <option></option>
                           ...
                           <option value="Amelia Springs, Jetersville, Deatonsville">
                              										Amelia Springs, Jetersville, Deatonsville
                           </option>
                           ...
                           <option value="Little River Turnpike, Lewinsville"> Little River
                              										Turnpike, Lewinsville
                           </option>
                           <option value="Loudon, Fauquier and Rappahannock Counties">
                              										Loudon, Fauquier and Rappahannock Counties
                           </option>
                           <option value="Loudon, Fauquier, and Rappahannock Counties">
                              										Loudon, Fauquier, and Rappahannock Counties
                           </option>
                           ...
                           <option value="Mechanicsville, Seven Days Battles">
                              										Mechanicsville, Seven Days Battles
                           </option>
                           ...
                           <option value="Yellow Tavern">Yellow Tavern</option></select></td>
                     <td><select name="regiment">
                           <option></option>
                           ...
                           <option value="Staunton Arty.">Staunton Artillery</option></select></td>
                     <td><select name="brigade">
                           <option></option>
                  ...
                  <option value="12">Dec.</option></select>-<select disabled name="start_day">
                  <option></option></select> - <select name="start_year">
                  <option selected value=""></option>
                  <option value="1861">1861</option>
                  <option value="1862">1862</option>
                  <option value="1863">1863</option>
                  <option value="1864">1864</option>
                  <option value="1865">1865</option></select>&#8211;&#8211;<select name="end_month">
                  <option></option>
                  <option value="01">Jan.</option>
                  <option value="02">Feb.</option>
                  <option value="03">Mar.</option>
                  ...
                  <option value="10">Oct.</option>
                  <option value="11">Nov.</option>
                  <option value="12">Dec.</option></select>-<select disabled name="end_day">
                  <option></option></select>-<select name="end_year">
                  <option></option>
                  <option value="1861">1861</option>
                  <option value="1862">1862</option>
                  <option value="1863">1863</option>
                  <option value="1864">1864</option>
                  <option value="1865">1865</option></select> concluding <span id="validationField"></span><br><br><b>State</b><br><select name="state">
                  <option></option>
                  ...
                  <option value="W.Va.">West Virginia</option></select><br><br><b>Commander</b><br><select size="5" name="commander">
                  <option></option>
                  ...
                  <option value="Col. Thomas F. McCoy and Maj. Henry J. Sheafer">Col. Thomas
                     							F. McCoy and Maj. Henry J. Sheafer
                  </option>
                  ...
                  <option value="Lt. Col. J. MacThompson- Capt. Emanuel D. Roath">Lt. Col. J.
                     							MacThompson- Capt. Emanuel D. Roath
                  </option>
