         ...
         <form method="GET" action="/cohabitation_search_results.html" name="cohabitationSearchForm"><input name="q" id="query" type="hidden"><input value="50" name="rows" type="hidden"><input value="0" name="start" type="hidden"><div id="wrapper">
               ...
               <div id="husbandInfo">
                  <div class="rowodd">
                     ...
                     <div class="content"><select name="cohab_husband_last_name">
                           ...
                           <option value="Z*">Z - 0</option></select></div>
                  </div>
                  <div class="roweven">
                     <div class="label">Husband's Occupation:</div>
                     <div class="content"><select name="cohab_husband_occupation">
                           <option value="">Select One...</option>
                           <option>Baker</option>
                           ...
                           <option>Whitewasher</option></select></div>
                  </div>
                  <div class="rowodd">
                     <div class="label">Husband's Birth Place:</div>
                     <div class="content"><select name="cohab_husband_birth_place">
                           <option value="">Select One...</option>
                           ...
                           <option>Westmoreland Co., VA</option></select></div>
                  </div>
                  <div class="roweven">
                     <div class="label">Husband's Age:</div>
                     <div class="content"> Min<input size="4" name="cohab_husband_age_min" type="text"> Max<input size="4" name="cohab_husband_age_max" type="text"></div>
                  </div>
                  <div class="rowodd">
                     <div class="label">Wife's Last Name Starts with:</div>
                     <div class="content"><select name="cohab_wife_last_name">
                           <option value="">Select One...</option>
                           <option value="A*">A - 24</option>
                  ...
                  <div class="roweven">
                     ...
                     <div class="content"><select name="cohab_wife_birth_place">
                           <option value="">Select One...</option>
                           ...
                           <option>Winchester, VA</option></select></div>
                  </div>
                  <div class="rowodd">
                     <div class="label">Wife's Age:</div>
                     <div class="content">Min<input size="4" type="text" name="cohab_wife_age_min"> Max<input size="4" type="text" name="cohab_wife_age_max"></div>
                  </div>
                  <div class="roweven">
                     <div class="label">Current Residence:</div>
                     <div class="content"><select name="cohab_current_residence">
                           <option value="">Select One...</option>
                           ...
                           <option>Willow Spout</option></select></div>
                  </div>
                  <div class="rowodd">
                     <div class="label">Number of Children:</div>
                     <div class="content">Min<input size="4" type="text" name="cohab_num_children_min">Max<input size="4" type="text" name="cohab_num_children_max"></div>
                  </div>
                  <div class="roweven">
                     <div class="label">Sort the Records By:</div>
                     <div class="content"><select name="sort">
