...
<img src="../VoS/images/images/vtitle4.gif" style="padding-left:10px;"><h2 class="red-head">Search the Valley of the Shadow Letters</h2>
<blockquote>
...
<div style="padding: 2em; max-width: 80%;"><form name="lettersSearchForm" action="/letters_search_results.html" method="get">
<input type="hidden" readonly name="q" id="query"><input type="hidden" readonly name="rows" value="50"><input type="hidden" readonly name="start" value="0"><hr>
<br> Search for word or phrase: <br><input name="search_text" size="40" value=""><br> within <br><select name="docs"><option value="all">All letters</option>
