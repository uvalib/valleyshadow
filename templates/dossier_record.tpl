...
<html>
  ...
  <link type="text/css" rel="stylesheet" href="../VoS/css/valleyshadow.css" />   
   ...
   <body vlink="#00009c" bgcolor="#ffffff" link="#cd7f32">
      ...
      <p>Results printed below are the short version of the results of your search. Columns in bold denote columns searched on (beyond
         the basic returns of Name, service information, and enlistment information. Clicking on the
         					last name of each person will allow you to see a full record for that individual
      </p>
      <p><b>Please cite results as coming from: </b>Augusta County, Virginia, Soldiers Records, Valley of the Shadow: Two Communities in the American Civil War, Virginia Center
         for Digital History, University of Virginia (http://valley.lib.virginia.edu/dossier_record?q=db:dossiers_augusta AND id_num:2117).
      </p>
      <div style="padding-bottom:1em;" class="navigationHeader"><a onClick="javascript:history.back()" href="javascript:history.back()"><b>Return to Search Results</b></a><br></div>
           {{range .Docs}}
      ...
      <table cellpadding="10" border="0" id="dossier">
         ...
         <tr class="data">
            ...
            <td valign="top" align="left">
               <p class="item"><b>Date of Enlistment:</b> {{ .date_enl }}<br></p>
         ...
         <tr class="data">
            <td valign="top" align="left">
               <p class="item"><b>Rank:</b> {{ .rank }}<br></p>
               <p class="item"><b>Company:</b> E<br></p>
               <p class="item"><b>Transfer Company:</b> <br></p>
               <p class="item"><b>Regiment:</b> 5th Va. Inf.
               </p>
            </td>
            <td valign="top" align="left">
               <p class="item"><b>Promotions:</b> <br></p>
               <p class="item"><b>Transfers and Other Service:</b> <br></p>
         ...
         <tr class="data">
            ...
            <td valign="top" align="left">
               ...
               <p class="item"><b>Family Number from 1860 census:</b> <a href="census_search_results?q=db:pop_aug_60 AND family_num:693 AND page_num:574&amp;sort=last asc, first asc&amp;county=aug&amp;year=1860&amp;rows=50&amp;start=0&amp;detailed=yes">693</a> (Click on number to see the 1860 census record) <br></p>
               <p class="item"><b>Dwelling Number from 1860 census:</b> <a href="census_search_results?q=db:pop_aug_60 AND dwelling_num:669 AND page_num:574&amp;sort=last asc, first asc&amp;county=aug&amp;year=1860&amp;rows=50&amp;start=0&amp;detailed=yes">669</a> (Click on number to see the 1860 census record) <br></p>
               <p class="item"><b>Postwar Life:</b> 1870 Census, Farmer, age 30, South River District, Augusta Co. Member of Stonewall Jackson Camp No. 25 C. V. Staunton 0120-93;
                  obituary states he was a sharpshooter<br></p>
               <p class="item"><b>Death Place:</b> Mint Spring<br></p>
