               ...
               <td>
                  ...
                  <blockquote>
                     <p>The 1890 U.S. Veterans Census Database allows users to search
                        										...
                        										County men who served in the war.
                     </p>
         ...
         <center>
            <form action="/veteran_search_results.html" name="veteranSearch" method="get"><input name="q" id="query" type="hidden"><input value="50" name="rows" type="hidden"><input value="0" name="start" type="hidden"><input value="vet_census_aug_90" name="db" type="hidden"><input value="last asc, first asc" name="sort" type="hidden"><table cellpadding="10">
                  ...
                  <tr>
                     ...
                     <td><input name="last_name" class="textField"></td>
                     <td align="right">First Name:</td>
                     <td><input name="first_name" class="textField"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td align="left"><select size="6" name="rank">
                           <option></option>
                           ...
                           <option value="Pvt.">Pvt.</option>
                           <option value="Sgt.">Sgt.</option>
                           <option value="US Sol.">US Sol.</option></select></td>
                     <td align="right">Company:</td>
                     <td align="left"><input size="25" class="textField" name="company"></td>
                  </tr>
                  <tr>
                     <td align="right">Regiment:</td>
                     <td align="left"><select name="regiment" size="6" type="text">
                           <option value=""></option>
